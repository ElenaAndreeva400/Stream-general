...
let appData = {
   ...
   'getExpensesMonth': function() {  // сумма всех расходов на месяц   // 1_1
    ...
    'getBudget': function(a, b) {  // 2
      return a-b;
      },   
    'getTargetMonth': function (appData.getBudget) {
      let time = Math.ceil((appData.mission/appData.getBudget));
       if (time > 0) {
...
console.log('Расходы за месяц: ', expensesAmount);  // 1_1
let accumulatedMonth = appData.getBudget(money, expensesAmount);  //2
appData.getTargetMonth(accumulatedMonth);    //3
